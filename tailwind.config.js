...
module.exports = {
  ...
  safelist: [
    'bg-emerald-100', 'text-emerald-600', 'text-emerald-700', 'bg-emerald-500', 'bg-emerald-50', 'border-emerald-200', 'text-emerald-800',
    ...
    'bg-violet-50', 'text-violet-700', 'border-violet-200', 'bg-violet-600', 'bg-violet-100', 'text-violet-600',
